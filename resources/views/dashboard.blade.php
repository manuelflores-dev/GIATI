        ...
        <div class="flex-1 flex">
            ...
            <div class="p-2 bg-secondary-100 w-60 flex-col hidden md:flex" id="sideNav">
                ...
                <nav>
                    ...
                    <a href="empleado" class="transform  hover:scale-105 transition duration-200 block text-black py-2.5 px-4 my-4 rounded-xl  hover:bg-gradient-to-r hover:from-red-600 hover:to-red-300 hover:text-white" href="">
                        <i class="fas fa-users mr-2"></i>Empleados
                    </a>
                    <a class="transform  hover:scale-105 transition duration-200 block text-black py-2.5 px-4 my-4 rounded-xl hover:bg-gradient-to-r hover:from-red-600 hover:to-red-300 hover:text-white" href="">
                    ...
                    <a class="transform  hover:scale-105 transition duration-200 block text-black py-2.5 px-4 my-4 rounded-xl  hover:bg-gradient-to-r from-red-600 to-red-300 hover:text-white" href="">
                        <i class="fas fa-road mr-2"></i>Mantenimientos
                    </a>
                    <a class="transform  hover:scale-105 transition duration-200 block text-black py-2.5 px-4 my-4 rounded-xl  hover:bg-gradient-to-r hover:from-red-600 hover:to-red-300 hover:text-white" href="">
                        <i class="fas mr-2"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                ...
                <p class="mb-1 px-5 py-3 text-left text-xs text-red-500">Torres Corzo</p>
                ...
                <div class="mt-12">
                    <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-5">
                        <div class="transform  hover:scale-105 transition duration-300 relative flex flex-col bg-clip-border rounded-3xl bg-white text-gray-700 shadow-orange-600/70  shadow-2xl">
                            ...
                            <div class="border-t border-blue-gray-50 p-4">
                                <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                                    <strong class="text-orange-500"></strong>&nbsp;Laptop
                                </p>
                            </div>
                        </div>
                        <a href="">
                            <div class="transform  hover:scale-105 transition duration-300 relative flex flex-col bg-clip-border rounded-3xl bg-white text-gray-700 shadow-2xl shadow-blue-600/70">
                                ...
                                <div class="border-t border-blue-gray-50 p-4">
                                    <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                                        <strong class="text-blue-500"></strong>&nbsp;Computadoras de escritorio</p>
                                </div>
                            </div>
                        </a>
                         ...
                         <a href="">
                            <div class="transform  hover:scale-105 transition duration-300 relative flex flex-col bg-clip-border rounded-3xl bg-white text-gray-700 shadow-2xl shadow-blue-600/70">
                                ...
                                <div class="border-t border-blue-gray-50 p-4">
                                    <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                                        <strong class="text-blue-500"></strong>&nbsp;Monitores
                                    </p>
                                </div>
                            </div>
                        </a>
                        <div class="transform  hover:scale-105 transition duration-300 relative flex flex-col bg-clip-border rounded-3xl bg-white text-gray-700 shadow-pink-600/70 shadow-2xl">
                            ...
                            <div class="border-t border-blue-gray-50 p-4">
                                <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                                    <strong class="text-pink-500"></strong>&nbsp;Teclados
                                </p>
                            </div>
                        </div>
                        <div class="transform  hover:scale-105 transition duration-300 relative flex flex-col bg-clip-border rounded-3xl bg-white text-gray-700 shadow-green-600/70 shadow-2xl">
                            ...
                            <div class="border-t border-blue-gray-50 p-4">
                                <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                                    <strong class="text-green-500"></strong>&nbsp;Ratones
                                </p>
                            </div>
                        </div>
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td>
                                                    <a href="recorrido/" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Finalizar
                                                    </a>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                ...
                                                <td>
                                                    <a href="pagarcuenta/" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Finalizar
                                                    </a>
                                                </td>
                                            </tr>
